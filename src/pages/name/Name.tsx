      ...
      <div className="p-8">
        <div className="mt-8 ml-[50px] flex flex-col">
          <h1 className="text-txt-black-600 leading-5 font-semibold text-3xl font-[inter] mb-4">
            What is abc resturent? Tell us more about the restaurant.
          </h1>
          ...
          <form>
            <input
              type="text"
              className="bg-white p-4 border border-[rgba(205, 212, 219, 1)]  w-[720px] mt-4 focus:border-palatinate-blue-500 active:border-palatinate-blue-500 active:outline-palatinate-blue-500 focus:outline-palatinate-blue-500"
            />
